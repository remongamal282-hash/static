...
// Use direct backend API for production (static server deployment)
// Use proxy only during development (npm run dev)
const IS_PRODUCTION = import.meta.env.PROD;
const BACKEND_API = 'https://backend.ascww.org/api/news';

const TARGET_URL = IS_PRODUCTION ? BACKEND_API : '/api/proxy/news';
const IMAGE_BASE_URL = IS_PRODUCTION
  ? 'https://backend.ascww.org/api/news/image/'
  : '/api/proxy/news/image/';
